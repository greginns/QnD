...
class Table_config_index_update extends MVC {
  constructor(element) {
    super(element);
  }
...
let page1 = new Page({el: el1, path: '/workspace/:workspace/app/:app/table/:table/config/index/:name/update', title: 'Tables - Config Index', sections: [section1]});
