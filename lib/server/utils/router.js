...
class Router {
  ...
  static add(msg) {
    ...
    // save authorizations
    if (msg.app & msg.subapp && msg.id) {
      Authorization.addActionLevel(msg.app, msg.subapp, msg.id, msg.level || DENIED);
    }
  }
...
class RouterMessage {
  constructor({method='post', app='', subapp='', version='v0', path='', id='', level=0, desc='', resp={}, rewrite=false, fn='', security={}} = {}) {
    /*
      security: {
        strategies: [
