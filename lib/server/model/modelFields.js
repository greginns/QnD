/*
                 Field
                 -----
CharType        NumType       DateType      Boolean     Json    Jsonb     UUID
--------        -------       --------                                    
Char            Integer       Date                                        
Text            Float         Time 
...
class Field {
  ...
  */
  ...
  build() {
    // SQL to build column
    let com = '';
    let ct = this._getColumnType();
    
    if ('default' in this.defn) {
      com += ` DEFAULT '${this.defn.default}'`;
  
      if (ct == 'Json') com += '::json';
      if (ct == 'Jsonb') com += '::jsonb';
    }
...
class Boolean extends Field {
  ...
  build(col) {
    ...
    if ('array' in this.defn) col += '[]'.repeat(this.defn.array);
