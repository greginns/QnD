...
/* Model actions */  
  ...
  static async select({pgschema = '', rec = {}, cols = '*', params = {}, showHidden = false} = {}) {
    ...
    text += ' ' + ('orderby' in params && params.orderby) ? params.orderby : orderBy;
    
    if ('limit' in params && params.limit) text += ' ' + params.limit;
    if ('offset' in params && params.offset) text += ' ' + params.offset;
