...
export default addMVCBindings = function(MVC) {
  ...
  MVC._addBinding('attr', function(el) {
    ...
    for (let key of keys) {
      ...
      this._addProxyFunction(path, function attr(val) {
...
/*
  MVC._addBinding('enabled', function(el) {
    ...
    let proxyIdx = this._addProxyFunction(path, function enabled(val) {
      el.disabled = !!!val;
    });
  ...
  MVC._addBinding('disabled', function(el) {
    ...
    let proxyIdx = this._addProxyFunction(path, function disabled(val) {
      el.disabled = !!val;
    });
  ...
  MVC._addBinding('show', function(el) {
    ...
    let proxyIdx = this._addProxyFunction(path, function show(val) {
  ...
  MVC._addBinding('hide', function(el) {
    ...
    let proxyIdx = this._addProxyFunction(path, function hide(val) {
      el.style.display = (!!val) ? 'none' : '';
    });
  ...
  MVC._addBinding('if', function(el) {
    ...
    let proxyIdx = this._addProxyFunction(path, function zif(val) {
      let show = !!val;
...
// JS expr based
  ...
  MVC._addBinding('xenabled', function(el) {
    ...
    this._addExpression(el, expr, function(val) {
      el.disabled = !!!val;
    });
  ...
  MVC._addBinding('xshow', function(el) {
    ...
    let tf = this._evaluate(el, expr, 'Invalid xshow Expression', true);
