...
class TableStore {
  ...
  */
  constructor({accessor='', model='', safemode=true, query='', where='', values=[], filters={}, conditions={}} = {}) {
  ...
  redo({model='', query='', where='', values=[], filters = {}, conditions={}} = {}) {
...
class TableView {
  /*
    ...
    To get access to a TableStore/TableQuery
