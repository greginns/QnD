...
class Singlesel extends MVC {
  constructor() {
    const template = document.getElementById('widget-singlesel');
    ...
    this.modal = new bootstrap.Modal(clone.querySelector('div.widget-singlesel-modal'));
  }
...
/*
    ...
    async function fred() {
      let res = await Module.widgets.singlesel.select(title, groups, value);
    }
