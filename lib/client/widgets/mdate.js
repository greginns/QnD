...
class MDateModal extends MDate {
  constructor(el) {
    super(el);

    this.modal = new bootstrap.Modal(el.querySelector('div.widget-mdate-modal'));
  }
...
class MDateCard extends MDate {
};

export {MDateModal, MDateCard};