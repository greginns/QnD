...
ALTER TABLE "gm"."items_Activity" ADD CONSTRAINT "items_activity_actgroup_fkey" FOREIGN KEY("actgroup") REFERENCES "gm"."items_Actgroup" ("code") ON DELETE NO ACTION,
...
ALTER TABLE "gm"."items_Lodging" ADD CONSTRAINT "items_lodging_lodglocn_fkey" FOREIGN KEY("lodglocn") REFERENCES "gm"."items_Lodglocn" ("code") ON DELETE NO ACTION,
