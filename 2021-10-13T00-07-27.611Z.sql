...
ALTER TABLE "gm"."items_Actrates"
 ADD CONSTRAINT "items_actrates_pricelevel_fkey" FOREIGN KEY("pricelevel") REFERENCES "gm"."items_Pricelevel" ("code") ON DELETE NO ACTION,
...
ALTER TABLE "gm"."items_Lodgrates"
 ADD CONSTRAINT "items_lodgrates_pricelevel_fkey" FOREIGN KEY("pricelevel") REFERENCES "gm"."items_Pricelevel" ("code") ON DELETE NO ACTION,
